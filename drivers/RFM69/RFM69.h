...
#ifdef MY_RFM69_CS_PIN
#define RF69_SPI_CS				MY_RFM69_CS_PIN
#else
...
#ifdef MY_SOFTSPI
SoftSPI<MY_SOFT_SPI_MISO_PIN, MY_SOFT_SPI_MOSI_PIN, MY_SOFT_SPI_SCK_PIN, SPI_MODE> _SPI;
#else
#include <SPI.h>
#define _SPI SPI
#endif
...
public:
	...
	virtual bool sendWithRetry(uint8_t toAddress, const void* buffer, uint8_t bufferSize,
	                           uint8_t retries=2, uint8_t retryWaitTime=
	                               40); //!< sendWithRetry (40ms roundtrip req for 61byte packets)
